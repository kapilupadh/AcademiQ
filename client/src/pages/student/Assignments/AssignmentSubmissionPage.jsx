    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {!isGraded && (
            <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-8 shadow-sm space-y-6">
              <h3 className="font-bold text-zinc-900 dark:text-white">Your Submission</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  {!previewUrl && submission?.file_path && (
                    <div className="space-y-2">
                      <p className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Currently Submitted File</p>
                      <div className="w-full max-w-sm rounded-xl overflow-hidden border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-800 flex items-center justify-center p-4">
                        {submission.file_path.endsWith('.pdf') ? (
                          ...
                          <img src={`http://localhost:5000/public/${submission.file_path}`} alt="Submission" className="w-full h-auto" />
                        )}
                      </div>
                    </div>
                  )}
                ...
                <div className="flex justify-end">
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-8 py-3 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white rounded-xl font-bold transition-all shadow-lg shadow-indigo-600/20"
                  >
