...
export default function Navbar({ page = "public" }) {
  ...
  // Shared classes (shadcn-like, neutral zinc)
  const GHOST_BTN_CLS =
    "relative inline-flex items-center justify-center rounded-md text-sm font-medium transition-all duration-200 hover:bg-zinc-100 hover:text-zinc-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 dark:hover:bg-zinc-800/70 dark:hover:text-zinc-50 dark:focus-visible:ring-zinc-600 h-9 w-9 text-zinc-600 dark:text-zinc-400";


  const DROPDOWN_CLS =
    "absolute right-0 mt-2 w-72 bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-lg shadow-zinc-900/5 dark:shadow-black/20 z-50 overflow-hidden";
  ...
  return (
    <header className="sticky top-0 z-30 w-full border-b border-zinc-200/80 bg-white/75 backdrop-blur-xl dark:border-zinc-800/70 dark:bg-zinc-950/75 h-16 flex items-center">
      <div className="grid grid-cols-[1fr_auto_1fr] items-center w-full px-4 md:px-6 gap-4">


        {/* ── LEFT: Logo ── */}
        <div className="flex items-center min-w-0 pl-12 md:pl-0">
          <Link
            to={page === "login" || page === "public" ? "/" : "/dashboard"}
          ...
          >
            ...
            <span className="text-lg font-semibold tracking-tight text-zinc-900 dark:text-zinc-50 hidden sm:block">
              Academi
              <span className="text-blue-600 dark:text-blue-500">Q</span>
            </span>
          </Link>
        </div>
        ...
        {/* ── RIGHT: Actions (symmetric, grouped) ── */}
        <div className="flex items-center justify-end gap-1.5">
                  ...
                  {notificationOpen && (
                    ...
                    >
                      <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-200 dark:border-zinc-800">
                        ...
                        <button className="text-xs font-medium text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-50 transition-colors">
                          Mark all read
                        </button>
                      </div>
                      <div className="max-h-[280px] overflow-y-auto py-1">
                        <div className="px-4 py-3 hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors cursor-pointer border-l-2 border-blue-500">
                      ...
                      <div className="p-1.5 border-t border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/50">
                        <Link
                          ...
                          className="block w-full text-center text-xs font-medium text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-50 transition-colors py-1.5 rounded-md hover:bg-zinc-100 dark:hover:bg-zinc-800"
                        >
                  ...
                  {dropdownOpen && (
                    ...
                    >
                      ...
                      <div className="p-1">
                        ...
                        <div
                          className={`${DROPDOWN_ITEM_CLS} opacity-60 cursor-not-allowed`}
                          title="Coming soon"
                        >
                      ...
                      <div className="p-1 border-t border-zinc-200 dark:border-zinc-800">
                        <button
                          ...
                          className="flex items-center gap-2 w-full px-3 py-2 rounded-md text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/30 transition-colors cursor-pointer"
                        >
          ...
          {/* Public CTA (when not authenticated) */}
          {!isAuthed && (
            <>
