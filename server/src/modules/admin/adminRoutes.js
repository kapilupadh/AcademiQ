...
router.get('/departments/:id/location', authenticateToken, checkAdmin, adminController.getDepartmentLocation);
router.patch('/departments/:id/location', authenticateToken, checkAdmin, adminController.updateDepartmentLocation);
