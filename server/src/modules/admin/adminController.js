...
// ── ADD THIS to server/src/modules/admin/adminController.js ──────────────────

// PATCH /admin/departments/:id/location
// Body: { latitude, longitude, geofence_radius }
// Admin sets GPS coordinates for a department's geofence
exports.updateDepartmentLocation = async (req, res) => {
  try {
    const { Department } = require('../../models');
    const { latitude, longitude, geofence_radius } = req.body;
